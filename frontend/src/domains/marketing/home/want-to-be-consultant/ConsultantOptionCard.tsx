...
interface ConsultantOptionCardProps {
  option: ConsultantOption;
  index: number;
}

function splitTitleInTwoLines(title: string): string[] {
...
function ConsultantOptionCard({ option, index }: ConsultantOptionCardProps) {
