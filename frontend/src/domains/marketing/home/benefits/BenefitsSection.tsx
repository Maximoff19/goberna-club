...
const BENEFIT_CARDS: readonly BenefitCardData[] = [
  {
    id: 'cajas1',
    imageSrc: '/cajas1.webp',
    alt: 'Sistema de validacion para consultores',
  ...
  },
  {
    ...
    text: 'Creacion de un perfil profesional verificado',
    featured: true,
  },
  {
    id: 'qr',
    imageSrc: '/qr.webp',
    alt: 'Codigo QR para consultor',
    text: 'Generacion de un codigo de Consultor (codigo QR)',
    featured: false,
  },
];
...
function BenefitsSection() {
  ...
  useEffect(() => {
    ...
    const centerFeaturedCardOnCompactScreens = () => {
      ...
      const featuredCardNode = cardsRowNode.querySelector('.benefits__card--featured') as HTMLElement | null;
      if (!featuredCardNode) {
        updateScrollIndicators();
        return;
      }
