...
function ConsultantAuthPage() {
  ...
  const continueToProfile = async () => {
    ...
    window.location.hash = latestProfile?.id
      ? `#mi-perfil/${latestProfile.id}`
      : "#formulario-perfil";
    window.scrollTo(0, 0);
  };
      ...
      <div className="consultant-auth__shell">
        <div className="consultant-auth__panel consultant-auth__panel--brand">
          ...
          <h1 id="consultant-auth-title" className="consultant-auth__title">
            Entra a Goberna Club y continua con tu acreditacion profesional.
          </h1>
          <p className="consultant-auth__copy">
            Ingresa con tu cuenta para gestionar tu perfil profesional y tu
            presencia publica dentro de la red.
          </p>
        </div>
        ...
        <div className="consultant-auth__panel consultant-auth__panel--form">
          <div className="consultant-auth__brand-mark consultant-auth__brand-mark--form">
            <img
              className="consultant-auth__brand-logo"
              src="/logo.webp"
              alt=""
              aria-hidden="true"
            />
            <span className="consultant-auth__brand-name consultant-auth__brand-name--dark">
              Goberna
            </span>
          </div>
          ...
          <div className="consultant-auth__form-wrap">
            ...
            {errorMessage && (
              <p className="consultant-auth__error">{errorMessage}</p>
            )}
            ...
            <form className="consultant-auth__form" onSubmit={handleLogin}>
              ...
              <PrimaryButton
                className="consultant-auth__submit"
                type="submit"
