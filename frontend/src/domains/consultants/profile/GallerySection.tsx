...
function GallerySection({ showEdit, gallery, profileId = '' }: GallerySectionProps) {
  ...
  // No mostrar nada si no hay imagenes y no esta en modo edicion
  ...
  const onSelectReplacementImage = async (event: ChangeEvent<HTMLInputElement>) => {
  ...
  const onSelectAddImages = async (event: ChangeEvent<HTMLInputElement>) => {
