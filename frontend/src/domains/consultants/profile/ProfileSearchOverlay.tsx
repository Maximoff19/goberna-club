...
interface ProfileSearchOverlayProps {
  isOpen: boolean;
  query: string;
...
function ProfileSearchOverlay({ isOpen, query, onQueryChange, profiles, onClose, onOpenProfile }: ProfileSearchOverlayProps) {
  const [isSearching, setIsSearching] = useState(false);
  const [visibleProfiles, setVisibleProfiles] = useState<ProfileSearchData[]>([]);
