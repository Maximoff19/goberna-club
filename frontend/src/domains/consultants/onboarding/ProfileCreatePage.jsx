...
const STEPS = ['basicos', 'contacto', 'experiencia', 'educacion', 'adicional'];
...
function ProfileCreatePage({ onProfileCreated }) {
  ...
  const isCurrentStepValid = () => {
    if (activeSection === 'basicos') {
      return formData.name?.trim() && formData.specialization;
    }
  ...
  const removeSkill = (skillId) => {
    setFormData((prev) => ({
      ...prev,
      skills: prev.skills.filter((item) => item !== skillId),
    }));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      window.location.hash = `#mi-perfil/${profileData.id}`;
    } catch (error) {
          ...
          <form className="profile-create__form" onSubmit={handleSubmit}>
            ...
            {activeSection === 'adicional' && (
              <div className="profile-create__section">
                ...
                <div className="profile-create__field">
                  <LabelWithTooltip tooltip="Seleccioná habilidades desde el catálogo para mantener el perfil normalizado y fácil de encontrar.">
                    Habilidades
                  </LabelWithTooltip>
                  <div className="profile-create__row">
                    <select
