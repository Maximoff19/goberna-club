...
function ReferralSection() {
  return (
    <section className="referral-section" aria-labelledby="referral-title">
      <div className="referral-section__safe-area">
        ...
        <div className="referral-section__panel">
          <h2 id="referral-title" className="referral-section__title">
            ¿Has llevado nuestros cursos de especialización y no has sido acreditado en nuestra red de Consultores?
          </h2>

          <p className="referral-section__subtitle">
            <span>Recomiéndanos y obtén la </span>
