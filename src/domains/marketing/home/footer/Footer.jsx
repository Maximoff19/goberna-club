...
import { openProfileSearchOverlay } from '../../../../app/navigation/profileSearchNavigation';
import './footer.css';
...
function Footer({ enableReveal = true }) {
        ...
        <section className="footer-main__top">
          <div className="footer-main__brand-column">
            ...
            <div className="footer-main__cta-row">
              <button type="button" className="footer-main__cta-ghost" onClick={openProfileSearchOverlay}>
                Buscar consultor
              </button>
              <PrimaryButton className="footer-main__cta-primary">Ser consultor</PrimaryButton>
            </div>
          </div>
        ...
        <section className="footer-main__bottom">
          ...
          <div className="footer-main__bottom-row">
            <p className="footer-main__legal-text">
              ...
              <br />
              México | Perú | Ecuador | Bolivia | Colombia | República Dominicana | Chile | Panamá | Costa Rica |
